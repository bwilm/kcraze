...
var Moltin, __indexOf = [].indexOf || function (a) {
...
Moltin = function () {
  ...
  return a.prototype.options = {
    ...
    for (c in b) e = b[c], d[c] = e;
    return d
  }, a.prototype.InArray = function (a, b) {
    return !b || __indexOf.call(b, a) < 0 ? !1 : !0
  }, a.prototype.Serialize = function (a, b) {
    var c, d, e;
    null == b && (b = null), d = [];
    for (c in a) e = a[c], c = null !== b ? b + "[" + c + "]" : c, d.push("object" == typeof e ? this.Serialize(e, c) : encodeURIComponent(c) + "=" + encodeURIComponent(e));
    return d.join("&")
  }, a.prototype.Error = function (a) {
    var b, c, d, e;
    if (c = "", "undefind" != typeof a.errors) {
      e = a.errors;
      for (b in e) d = e[b], c += d + "<br />"
    } else c = a.error;
    return this.options.notice("Error", c)
  }, a.prototype.Authenticate = function (a, b) {
    var c, d;
    return this.options.publicId.length <= 0 && "function" == typeof b && b("error", "Public ID must be set", 401), null !== this.Storage.get("mtoken") && parseInt(this.Storage.get("mexpires")) > Date.now() ? (this.options.auth = {
      expires: 1e3 * parseInt(this.Storage.get("mexpires")),
      token: this.Storage.get("mtoken")
    }, "function" == typeof a && a(this.options.auth), d = document.createEvent("CustomEvent"), d.initCustomEvent("MoltinReady", !1, !1, this), window.dispatchEvent(d), this) : (c = {
      grant_type: "implicit",
      ...
      data: c,
      async: "function" == typeof a ? !0 : !1,
      headers: {
        "Content-Type": "application/x-www-form-urlencoded"
      },
      success: function (b) {
        return function (c, e, f) {
          b.Storage.set("mexpires", c.expires), b.Storage.set("mtoken", c.token_type + " " + c.access_token), b.options.auth = {
            expires: 1e3 * parseInt(b.Storage.get("mexpires")),
            token: b.Storage.get("mtoken")
          }, "function" == typeof a && a(c), d = document.createEvent("CustomEvent"), d.initCustomEvent("MoltinReady", !1, !1, b), window.dispatchEvent(d)
        }
      }(this),
      error: function (a) {
        return function (a, c, d) {
          return "function" == typeof b ? b("error", "Authorization failed", 401) : void 0
        }
      }(this)
    }), this)
  }, a.prototype.Request = function (a, b, c, d, e) {
    var f, g;
    return null == b && (b = "GET"), null == c && (c = null), f = {}, g = {
      "Content-Type": "application/x-www-form-urlencoded",
      Authorization: this.options.auth.token
    }, null === this.options.auth.token && "function" == typeof e && e("error", "You much authenticate first", 401), Date.now() >= this.options.auth.expires && this.Authenticate(null, e), this.InArray(b, this.options.methods) || "function" == typeof e && e("error", "Invalid request method (" + b + ")", 400), this.options.currency && (g["X-Currency"] = this.options.currency), this.options.language && (g["X-Language"] = this.options.language), this.Ajax({
      method: b,
      path: a,
      data: c,
      async: "function" == typeof d ? !0 : !1,
      headers: g,
      success: function (a) {
    ...
    }), "undefined" == typeof d ? f.result : void 0
    ...
    }, b = this.Merge(b, a), b.method = b.method.toUpperCase();
    try {
    ...
    }(this), b.timeout), h = b.headers;
    for (d in h) g = h[d], e.setRequestHeader(d, g);
    return e.onreadystatechange = function () {
      var a;
      return 4 !== e.readyState ? null : (clearTimeout(f), a = JSON.parse(e.responseText), "2" !== e.status.toString().charAt(0) ? b.error(a, e.status, e) : b.success(a, e.status, e))
    }, e.send(b.data)
  }, p = function () {
    function a() {}
    return a.prototype.set = function (a, b, c) {
      var d, e;
      return e = "", c && (d = new Date, d.setTime(d.getTime() + 24 * c * 60 * 60 * 1e3), e = "; expires=" + d.toGMTString()), document.cookie = a + "=" + b + e + "; path=/"
    }, a.prototype.get = function (a) {
      var b, c, d, e;
      for (a += "=", e = document.cookie.split(";"), c = 0, d = e.length; d > c; c++) {
        for (b = e[c];
    ...
    return a.prototype.Get = function (a, b, c) {
      ...
      var d;
      return null == a && (a = 0), d = this.endpoint + "/" + (0 !== a ? a + "/fields" : "fields"), this.m.Request(d, "GET", null, b, c)
    }, a
  }(), c = function () {
    function a(a) {
      this.m = a
    ...
    return a.prototype.Get = function (a, b, c, d) {
      ...
      var e;
      return null == a && (a = 0), null == b && (b = 0), e = a > 0 && 0 >= b ? "customers/" + a + "/addresses/fields" : a > 0 && b > 0 ? "customers/" + a + "/addresses/" + b + "/fields" : "addresses/fields", this.m.Request(e, "GET", null, c, d)
    }, a
  }(), d = function (a) {
    function b() {
    ...
    return a.prototype.Identifier = function (a, b) {
      ...
      return null == b && (b = 1), null == c && (c = null), this.m.Request("carts/" + this.cartId, "POST", {
        id: a,
        quantity: b,
        modifier: c
      }, d, e)
      ...
      return null === a || a === !1 ? this.m.Request("carts/" + this.cartId + "/discount", "DELETE", null, b, c) : this.m.Request("carts/" + this.cartId + "/discount", "POST", {
        code: a
      }, b, c)
    }, a
  }(), f = function (a) {
    ...
    return __extends(b, a), b.prototype.endpoint = "currencies", b.prototype.Set = function (a, b, c) {
      return this.m.Storage.set("mcurrency", a), this.m.options.currency = a, "function" == typeof b ? b(a) : void 0
    }, b
  }(b), j = function () {
    function a(a) {
      this.m = a
    ...
    return a.prototype.Set = function (a, b, c) {
      return this.m.Storage.set("mlanguage", a), this.m.options.language = a, "function" == typeof b ? b(a) : void 0
    }, a
  }(), m = function (a) {
    function b(a) {
      this.m = a
